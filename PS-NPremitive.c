...
{ 
      ...
      { 
            ...
            for(i = 0; i < limit; i++) 
            {
                  if(P[i].at <= time && P[i].status != 1 && P[i].pt<P[largest].pt) 
                  { 
                        largest = i;
                  } 
            }
            ...
            printf("\n%c     %d    %d    %d    %d    %d    %d\n",P[largest].pn,P[largest].at,P[largest].bt,P[largest].pt,P[largest].ct,P[largest].tat,P[largest].wt); 
        }
}
